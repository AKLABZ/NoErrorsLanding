...
const sounds = {
  N: ["piano-keys/key13.mp3?v=1"],
  O: ["piano-keys/key20.mp3?v=1"],
  o: ["piano-keys/key15.mp3?v=1"],
  E: ["piano-keys/key06.mp3?v=1"],
  R: ["piano-keys/key18.mp3?v=1"],
  r: ["piano-keys/key01.mp3?v=1"],
  S: ["piano-keys/key17.mp3?v=1"],
  '\u002E': ["piano-keys/key18.mp3?v=1"],
  '\u0C97': ['piano-keys/key03.mp3?v=1'],
  '\u00B0': ["piano-keys/key22.mp3?v=1"],
  '\u0028': ["piano-keys/key01.mp3?v=1"],
  '\u0434': ["piano-keys/key17.mp3?v=1"],
  '\u3002': ["piano-keys/key20.mp3?v=1"],
  '\u0029': ["piano-keys/key01.mp3?v=1"],
  '\u0E51': ["piano-keys/key06.mp3?v=1"],
  '\u0027': ["piano-keys/key20.mp3?v=1"],
  '\u2022': ["piano-keys/key22.mp3?v=1"],
  '\u0020': ["piano-keys/key19.mp3?v=1"],
  '\u032B': ["piano-keys/key13.mp3?v=1"],
  '\u0942': ["piano-keys/key03.mp3?v=1"],
  '\u00B4': ["piano-keys/key13.mp3?v=1"],
  '\u0060': ["piano-keys/key13.mp3?v=1"],
};
